    ...
    <section className="grid gap-6 md:grid-cols-[220px_1fr]">
      <aside className="rounded-3xl bg-[#051530] p-5 text-white">
        ...
        <nav className="mt-5 grid gap-3 text-sm">
          ...
          <Link href="/admin/resenas-observadas">Reseñas ya observadas</Link>
          <Link href="/admin/verificaciones">Verificaciones</Link>
          <Link href="/admin/cuentas-verificadas">Cuentas verificadas</Link>
          <Link href="/admin/cursos-cuentas">Cursos de cuentas</Link>
