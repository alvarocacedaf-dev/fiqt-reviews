...
export type Review = { id: string; clarity_rating: number; difficulty_rating: number; fairness_rating: number; treatment_rating: number; workload_rating: number; course_demand_rating: number; recommendation: 'like' | 'dislike'; selected_tags: string[]; comment: string; created_at: string };
